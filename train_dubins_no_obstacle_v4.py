...
TXT_NAME = '1model_'+Env.__name__+'_v4.txt'
BMODEL_PATH = name_dict['db'].replace('.pt', '_v4.pt')
...
if __name__ == '__main__':
    ...
    for _ in tqdm(range(N_DATASET)):
        while True:
            env = Env(num_agents=NUM_AGENTS, mode='barrier', PROB=(OBSTACLE_DENSITY,OBSTACLE_DENSITY), SIZE=(MAP_SIZE,MAP_SIZE))
