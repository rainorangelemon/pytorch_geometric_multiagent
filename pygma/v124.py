...
'''
WARNING: this script only trains the safe set with the Lie derivative condition, go to v109 for workable script
'''

if __name__ == '__main__':
    from configs.dubins.v123 import *
else:
    from configs.dubins.v120 import *
