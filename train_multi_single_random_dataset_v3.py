...
TXT_NAME = '1model_'+Env.__name__+'_point_v3.txt'
BMODEL_PATH = name_dict['db'].replace('.pt', '_point_v3.pt')
...
if __name__ == '__main__':
    ...
    bnn = OriginGNNv4(HIDDEN_SIZE, 3, keys=['agent', 'obstacle'])
    bnn.to(device)
